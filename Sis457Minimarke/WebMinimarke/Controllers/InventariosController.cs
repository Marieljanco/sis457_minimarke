...
namespace WebMinimarke.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public InventariosController(LabMinimarkeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdProducto,IdProveedor,IdEmpleado,CantidadStock,FechaUltimaRepocision")] Inventario inventario)
        {
            ...
            ViewData["IdEmpleado"] = new SelectList(_context.Empleados, "Id", "Id", inventario.IdEmpleado);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdProducto,IdProveedor,IdEmpleado,CantidadStock,FechaUltimaRepocision")] Inventario inventario)
        {
            if (id != inventario.Id)
            {
                return NotFound();
