...
namespace WebMinimarke.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(LabMinimarkeContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,NombreEmpresa,Direccion,Celular,CorreoElectronico,UsuarioRegistro,FechaRegistro,Estado")] Proveedor proveedor)
        {
            if (id != proveedor.Id)
            {
                return NotFound();
